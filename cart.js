...
function display(cartdata) {
    ...
    cartdata.forEach(function (elem, index) {
        ...
        td5.innerHTML = "<img src=\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZ2qxxrocB2XyYTstDgPUqe1pJ2i1ZbGD0qA&usqp=CAU\"width=\"15%\" height=\"15%\"\background-color=transaparent\">";
...
function checkout(cartdata) {
    ...
    document.querySelector("#checkout").append(summary, subtotal, shipping, total, coupon_entered,  coupon_status, discount, last_amount_display,coupon_submit,checkoutButton);
}
...
function apply_coupon(){
    ...
    if(x=="masai30"){
       ...
       document.querySelector("#display").innerText="Coupon applied sucessfully";
        ...
        document.querySelector("#dsp_last_total").innerText="Amount to pay : Rs. "+totalCartValue;
